...
class LinkedStack:
    ...
    class _Node:
        ...
        __slots__='_element','_next' # Usage de la memoire de facon rationnelle

        def __init__(self,element,next): # Initialisation du champ des noeuds
            self._element=element       # Fait reference a l'element utilisateur
            self._next=next              # Fait reference au noeud suivant
